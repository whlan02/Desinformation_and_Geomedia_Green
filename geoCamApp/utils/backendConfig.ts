...
const DEV_BASE_URL = Platform.OS === 'web' ? 'http://localhost:5001' : 'http://192.168.0.234:5001';
const DEV_STEG_URL = Platform.OS === 'web' ? 'http://localhost:3001' : 'http://192.168.0.234:3001';
