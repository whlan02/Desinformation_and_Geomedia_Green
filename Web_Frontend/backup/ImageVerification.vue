...
import { verifyImagePurePng } from '../../services/verificationService.js';
...
.result-header, .info-header, .map-header, .error-header {
  display: flex;
  align-items: flex-start;
  margin-bottom: 1rem;
}

.result-title, .info-title, .map-title, .error-title {
  flex: 1;
}

.result-title h3, .info-title h3, .map-title h3, .error-title h3 {
  margin: 0 0 0.25rem 0;
  font-size: 1.125rem;
  font-weight: 600;
}

.result-title p, .info-title p, .map-title p, .error-title p {
  margin: 0;
  color: #64748b;
  font-size: 0.875rem;
}
